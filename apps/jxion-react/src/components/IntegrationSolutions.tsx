...
import styles from "@jxion/design/components/UstadIntegrationSolutions.module.scss";
...
export const IntegrationSolutions: React.FC<IntegrationSolutionsProps> = ({
  ...
  return (
    <section
      className={`${styles.integrationSolutions} ${styles[`integrationSolutions--${layout}`]}`}
    >
              ...
              <div className={styles.integrationSolutions__itemContent}>
                ...
                <ul className={styles.integrationSolutions__features}>
                  {solution.features.map((feature, featureIndex) => (
                    <li
                      key={featureIndex}
                      className={styles.integrationSolutions__feature}
                    >
                      {feature}
                    </li>
                  ))}
