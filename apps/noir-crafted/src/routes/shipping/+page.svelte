...
<script lang="ts">
  ...
  $: sectionProps = contentData?.shipping ? {
    title: contentData.shipping.title || 'Kargo ve Teslimat',
    subtitle: contentData.shipping.subtitle || '',
    description: contentData.shipping.description || '',
    content: contentData.shipping.content || '',
    footerContent: contentData.shipping.footerContent || '',
    variant: 'default',
    size: 'large',
  } : null;
