...
export function threeR3FPlugin(): Plugin {
  return {
    ...
    resolveId(id, importer, options) {
      ...
      // Note: react-reconciler is now handled by Vite's pre-bundling directly
      // The CommonJS module will be transformed to ES module automatically
      // No stub needed as long as it's in optimizeDeps.include
