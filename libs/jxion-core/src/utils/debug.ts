...
/**
 * Safely get NODE_ENV value, works in both Node.js and browser environments
 */
function getNodeEnv(): string {
  ...
  // For Vite-based environments, check for import.meta (only in ESM contexts)
  // Use a try-catch with dynamic evaluation to avoid TypeScript errors in CommonJS builds
  try {
    ...
    // Ignore errors - import.meta not available in this context
  }
