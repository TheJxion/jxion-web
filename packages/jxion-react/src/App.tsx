...
function App() {
  const { messages, isLoading: messagesLoading, error: messagesError, fetchMessages, addMessage } = useMessages()
  const { greeting, isLoading: greetingLoading, error: greetingError, fetchGreeting } = useGreetings()
